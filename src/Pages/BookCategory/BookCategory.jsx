...
const BookCategory = () => {
    ...
    return (
        <div className='my-20'>
                <h1 className='text-3xl font-bold  border-pink-500 dark:text-white border-l-4 pl-4 mb-10'>Books Category</h1>
                ...
                categoryBook.map(category => 
                        <div key={category._id} className='border p-3 border-gray-200 rounded-md'>
                             <img className='h-[180px] w-full rounded-md' src={category.image} alt="" srcset="" />
                              <h3 className='text-xl my-2 font-bold dark:text-white '>{category.category}</h3>
