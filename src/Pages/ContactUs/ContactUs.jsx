...
import contact from '../../assets/images/slider/contactUs.jpg';
function ContactUs() {
    return (
        <div>
            <h1 className='text-3xl font-bold  border-pink-500 border-l-4 pl-4'>Get In Touch</h1>
           
            <div className="flex lg:flex-row flex-col-reverse items-center  justify-around gap-5">
        <div className="lg:w-[45%] w-full">
        <form  className='rounded-md shadow-lg p-5'>
