...
function BookDetails() {
    ...
    const {bookImage,bookName,quantity,rating,authorName,category,details} = bookDetails
    return (
        ...
        <div>
           ...
           <div>
             <h3 className='font-bold text-red-500 text-2xl'>{bookName}</h3>    
                ...
                <button onClick={() => handleMyCart(productAllInfo._id)} className='py-2 rounded-md text-white bg-red-500 px-16 mt-3'>Borrow</button> <br />
